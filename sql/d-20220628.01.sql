/* 
  Add 5 columns to the product table:
  - two govern visibility in the Online Product Catalog (publish_eu, publish_usa)
...
alter table t_product add column publish_eu bit not null;
alter table t_product add column stock_usa smallint unsigned not null default '0';
alter table t_product add column stock_eu smallint unsigned not null default '0';
alter table t_product add column stock_zh smallint unsigned not null default '0';
