/* 
  Adds new_arrival field to the product table and related views.
  
  Created: 9/27/2022 by Derek Gau
  Deployed: 9/28/2022 by Derek Gau
*/
alter table t_product add column `new_arrival` bit not null;
