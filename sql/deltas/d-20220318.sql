-- Create a product catalog view. It is similar to the product view, but it just contains the queryable fields for searching products, it also contains oem refs in one column
